...
import { useRouter } from "next/navigation"; // Import the router to redirect
import { supabase } from "@/supabaseClient"; // Ensure the supabase client is imported
...
export default function Header() {
  ...
  const handleLogout = async () => {
    try {
      await supabase.auth.signOut(); // Sign out the collector
